...
public class TestStopReasons {
    ...
    void testGetStateFromValue(){
        ...
        assertEquals(Optional.of(StopReasons.EMPTY_INVENTORY), StopReasons.getStopReasonsFromId(10));
        assertEquals(Optional.of(StopReasons.MAINTENANCE_NEEDED), StopReasons.getStopReasonsFromId(11));
        assertEquals(Optional.of(StopReasons.MANUAL_STOP), StopReasons.getStopReasonsFromId(12));
        assertEquals(Optional.of(StopReasons.MOTOR_POWER_LOSS), StopReasons.getStopReasonsFromId(13));
